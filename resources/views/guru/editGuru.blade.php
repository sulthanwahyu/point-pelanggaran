    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="basic-form">
                <form class="form-valide-with-icon" action="/guru/up/{{$guru->id}}" method="post">
                        @csrf
                        @method('PATCH')
                      <div class="form-group">
                        <label  for="nama" class="form-label">Name</label>
                        <input name="nama"  value="{{$guru->nama}}"  type="text" class="form-control">
                      </div>
                      <div class="form-group">
                        <label  for="nipd"  class="form-label">Nipd</label>
                        <input name="nipd"  value="{{$guru->nipd}}"   type="text" class="form-control" >
                      </div>
                      <div class="form-group">
                        <label  for="alamat"  class="form-label">Alamat</label>
                        <input name="alamat" type="text"  value="{{$guru->alamat}}"   class="form-control">
                      </div>
                      <div class="form-group">
                        <label  for="nohp"  class="form-label">No Ponsel</label>
                        <input name="nohp" type="text"  value="{{$guru->nohp}}"   class="form-control" >
                      </div>
                      <div class="form-group">
                        <label  for="email"  class="form-label">Email</label>
                        <input name="email" type="email"  value="{{$guru->email}}"   class="form-control" >
                      </div>
                       <div class="mb-3">
                        <label for="disabledSelect" class="form-label">Kelas</label>
                        <select id="disabledSelect"  value="{{$guru->kelas_id}}"   class="form-select" name="kelas_id">
