                  ...
                  <div class="col-12">
                      <div class="card">
                          <div class="card-header">
                              <h2>Detail dari Pelanggaran : {{$pelanggaran->jenispelanggaran}}</h2>
                              {{-- <div id="point">
                              <h2 > 
                                  POINT : <span id="nilai">{{$pelanggaran->point}}</span>
                              </h2>
                          </div> --}}
                          </div>
                          <div class="card-body">
                              ...
                              <div class="infosis">
                                  ...
                                  <div class="infodeta">
                                  <div class="left">
                                  <h6>Jenis Pelanggaran : {{$pelanggaran->jenispelanggaran}}</h6>
                                  <h6>Tindakan : {{$pelanggaran->tindakan}}</h6>
                                  <h6>Point : {{$pelanggaran->jmlh_point}}</h6>
                                  {{-- <h6>No Ponsel :{{$pelanggaran->nohp}}</h6>
                                  <h6>Alamat :{{$pelanggaran->alamat}}</h6>
                                  <h6>Kelas : {{$pelanggaran->kelas['nama']}}</h6> --}}
                              </div>
                              <div class="right">
                                  {{-- <h6>Jenis Kelamin : {{$pelanggaran->jeniskelamin}}</h6> --}}
                                  {{-- <h6>Jurusan : {{$pelanggaran->jurusan['nama']}}</h6> --}}
                              </div>
                          </div>
                              </div>
                              <div class="btn-back">
                                  <a href="/pelanggaran"><Button type="button" class="btn btn-primary">Kembali</Button></a>
                              </div>
                          </div>
                      </div>
                  </div>
