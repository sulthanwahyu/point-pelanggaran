    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="basic-form">
                <form class="form-valide-with-icon" action="/pelanggaran/add_pelanggaran" method="post">
                        @csrf
                      <div class="form-group">
                        <label class="form-label">Jenis Pelanggaran</label>
                        <input name="jenispelanggaran" type="text" class="form-control">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input name="jmlh_point" type="number" class="form-control">
                      </div>
