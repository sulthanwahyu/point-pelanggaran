...
class HomeController extends Controller
{
    ...
    {
        // $home = laporan::with('guru','pelanggaran','siswa')->get();
        // return view('dashboardHome', compact('home'));
    }
    ...
    public function create()
    {
        ...
        // return view('dashboardHome', compact( 'laporan','siswa','guru','pelanggaran'));
    }
    ...
    public function show($id)
    {
        ...
        // return view('detailHome', compact('siswa'));
    }
    ...
    public function edit($id)
    {
        ...
        // return view('dashboarhomed', compact('laporan'));
    }
